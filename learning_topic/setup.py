    ...
    entry_points={
        'console_scripts': [
         ...
         'interface_object_sub  = learning_topic.interface_object_sub:main',
          'apple_detector = learning_topic.apple_detector:main',
          'apple_detection_listener = learning_topic.apple_detection_listener:main',
          'draw_circle = learning_topic.draw_circle:main',
          'apple_controlled_turtle = learning_topic.apple_controlled_turtle:main',
        ],
    },
)
